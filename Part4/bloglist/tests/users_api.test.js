...
describe('adding new users', () => {
  ...
  test.only('adding valid user works OK', async () => {
    const user = {
      username: 'antoniogh',
      password: '1234',
      name: 'Antonio'
  ...
  test.only('adding user without username returns 400 bad request', async () => {
    const user = {
      password: '1234',
      name: 'Antonio'
    }
  ...
  test.only('adding shorter username as allowed returs 400 bad request', async () => {
    const user = {
      username: 'an',
      password: '1234',
      name: 'Antonio'
  ...
  test.only('adding user without password returns 400 bad request', async () => {
    const user = {
      username: 'an',
      name: 'Antonio'
    }
  ...
  test.only('adding user with shorter password as allowed returns 400 bad request', async () => {
    const user = {
      username: 'an',
      password: '12',
      name: 'Antonio'
  ...
  test.only('adding an excisting user returns 400 bad request', async () => {
